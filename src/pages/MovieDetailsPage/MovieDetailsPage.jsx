...
import { getMovieDetails } from '../../components/MovieList/Movies'
...
<h3 className={css.title}>{film.original_title}({film.release_date?.slice(0,4)})</h3>
...
<Link to='cast' state={location.state} className={css.information} onClick={() => window.scrollTo({ top: 800 }) }>Cast</Link>
    
    <Link to='reviews' state={location.state} className={css.information} onClick={() => window.scrollTo({ top: 800 }) }>Reviews</Link>
